...
#
# Syntax:
# nset $varName $index ... $sublist
#
# Arguments:
# varName       Variable where a valid ndlist is stored
# index ...     Indices to set at
...
# nreplace --
#
# Replace portion of ndlist - return new list, same rank.
...
# nremove --
#
# Remove portion of ndlist - return value.
#
# Syntax:
