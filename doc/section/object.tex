...
To simplify things, three wrapper classes have been added, \cmdlink{scalar} for 0D objects, \cmdlink{vector} for 1D objects, and \cmdlink{matrix} for 2D objects. 
